...
*/
/* #define LUA_32BITS */
/* LightAir: force 32-bit build unconditionally so the C core and the C++
** binding can never disagree on the lua_Number/lua_Integer ABI, whatever
** per-language compiler flags the build system passes. */
