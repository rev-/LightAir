...
//   which is the only device with _totems[] populated) replies to every
//   MSG_TOTEM_BEACON from a configured totem with a 0xF1 carrying its
//   assigned role:
//
...
//   Runners check _role == ROLE_UNKNOWN on the first 0xF1 to identify
//   the activation message and return early without a game interaction.
//
